            ...
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <p class="data">{{ course.students }}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：{{
                            course.lessons
                        }}课时/{{ course.lessons * 1.5 }}小时&nbsp;&nbsp;&nbsp;&nbsp;难度：{{ course.level_name }}</p>
                ...
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        <div class="tab-item-title">
                            ...
                            <p class="chapter-length">共{{ chapter_length }}章 75个课时</p>
                        </div>
                        <div class="chapter-item" v-for="(chapter, index) in course_list" :key="index">
                            <p class="chapter-title">{{ chapter.name }}</p>
                            <ul class="lesson-list">
                                <li class="lesson-item" v-for="(lesson, i) in chapter.coursesections" :key="i">
                                    <p class="name"><span class="index">{{ index + 1 }}-{{ i + 1 }}</span> {{lesson.name}}
        ...
        return {
            ...
            playerOptions: {
                ...
                sources: [{ // 播放资源和资源格式
                    type: "video/mp4",
                    //你的视频地址（必填）
                    src: this.course_video,
                }],
                poster: this.course_img, //视频封面图
